              ...
              <div className="founders-grid">
                ...
                <div className="founder-card team-card">
                  ...
                  <div className="team-card-content">
                    ...
                    <p className="team-member-title">Co-Founder / Cybersecurity Expert</p>
                    <p className="team-member-description">
                      Cybersecurity expert and professional website development specialist
                    </p>
                    <div className="team-social-links">
                      <a
                        href="https://www.linkedin.com/in/deepak-jangir-17560b298/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="social-btn linkedin-btn"
                        aria-label="LinkedIn Profile"
                      ...
                      <a
                        href="https://github.com/deepakjangir12345"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="social-btn github-btn"
                        aria-label="GitHub Profile"
                ...
                <div className="founder-card team-card">
                  ...
                  <div className="team-card-content">
                    ...
                    <h4 className="team-member-name">Adarsh Pandey</h4>
                    <p className="team-member-title">Data Science & Machine Learning Developer</p>
                    <p className="team-member-description">
                      Expert in data science, machine learning, and AI development
                    </p>
                    <div className="team-social-links">
                      <button
                        className="social-btn linkedin-btn"
